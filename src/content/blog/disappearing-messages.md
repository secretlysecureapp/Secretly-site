...
Encryption protects a message in transit. But a conversation that lives forever on a device is still a risk — if the phone is lost, seized, or simply seen over your shoulder. Disappearing messages solve the other half of the problem.
